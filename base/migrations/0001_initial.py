    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=20, unique=True, validators=[django.core.validators.RegexValidator(message='Enter a valid username. This value may contain only letters, numbers, and @/./+/-/_ characters.', regex='^[\\w.@+-]+$')], verbose_name='username')),
                ('first_name', models.CharField(blank=True, help_text="User's first name", max_length=150, null=True, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, help_text="User's last name", max_length=150, null=True, verbose_name='last name')),
                ('otp_code', models.CharField(blank=True, help_text='Auto-generated secure code for user verification', max_length=6, null=True, verbose_name='secure code')),
                ('otp_expiry', models.DateTimeField(blank=True, help_text='The date and time when the secure code expires', null=True, verbose_name='secure code expiry')),
                ('is_active', models.BooleanField(default=False, help_text='Designates whether this user should be treated as active. Unselect this instead of deleting accounts.', verbose_name='active')),
                ('is_patient', models.BooleanField(default=False, help_text='Designates whether the user is a patient.', verbose_name='is patient')),
                ('is_pharmacy_owner', models.BooleanField(default=False, help_text='Designates whether the user is a pharmacy owner.', verbose_name='is pharmacy owner')),
                ('is_lock', models.BooleanField(default=False, help_text='Designates whether the user account is locked due to too many failed login attempts.', verbose_name='is locked')),
                ('login_attempts', models.PositiveIntegerField(default=0, help_text='Number of failed login attempts', verbose_name='login attempts')),
                ('locked_until', models.DateTimeField(blank=True, help_text='The date and time until which the account is locked', null=True, verbose_name='locked until')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, help_text='Upload a profile image (JPG, PNG, WebP). Max size: 5MB.', null=True, upload_to=base.models.profile_image_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'webp']), base.utils.validate_profile_image], verbose_name='profile image')),
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['otp_code'], name='base_user_otp_cod_9ce30c_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
